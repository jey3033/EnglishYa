        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <x-modal id="transaction-{{ $transaction->id }}" title="Transaction Detail" variant="info" :data="[
                    ...
                    <button type="button" class="btn btn-danger open-delete-modal" data-url="{{ route('transaction.destroy', $transaction) }}" data-name="Invoice {{ $transaction->invoice }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
